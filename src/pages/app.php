        ...
        <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li><?php
                if($nome!="Entrar") {
                    ...
                    echo "<li><a href='../functions/logout.php'>Sair</a></li>";
                }else{
        ...
        <ul id="slide-out" class="sidenav">
            ...
            <li>
                ...
                if($email=="") {
                    ...
                    echo "<a class='waves-effect' href='../functions/logout.php'>Sair";
                }
                ?>
                </a></li>
        </ul>
...
<div class="parallax-container">
    <div class="parallax"><img src="../../public/imagens/6.jpg"></div>
</div>
<div class="section white">
    <div class="row container">
        <div class="row center">
...
<div class="parallax-container">
    <div class="parallax"><img src="../../public/imagens/8.jpg"></div>
</div>
<div class="section white">
    <div class="row container">
